...
<body>
  <style>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-10">
            <?php
             echo "<img style='width:30px; height:30px; margin:20px;' src='images/destination.png'><span id='br'> $num</span> <button style='margin-left:auto;' id='ad' class='btn btn-primary' onclick='dodaj()'>Dodaj</button>  <hr>\n";
            ?>
  ...
  for(let i of spisakzaposlenih)
  {
    ...
    <div class="card ml-3" style="width: 24%;">
  <img style="width:100%; height:150px; " src="uploads/${i['pocetna']}" class="card-img-top" alt="...">
  <div class="card-body">
  <form action="admin/snimi.php" method="POST">
    <h6 class="card-title text">${i['country']}</h6>
    <h5 class="card-title">${i['city']} - ${i['price']}€</h5>
    <div class="row">
    <div class="col-md-12">
    <input style="width:100%;" name="delete" type="submit"  class="btn btn-primary" value="Obrisi">
    <input type="hidden" name="id_to_delete" value="${i['id']}">
    </div>
    </div>
      </form>
      <br>
      <button style="width:100%;"  class="btn btn-primary" onclick="izmenadest(${i['id']})">Izmeni</button>
     <br>
     <br>
